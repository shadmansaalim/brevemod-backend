...
const cancelEnrollment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Getting authenticated user from request
    const user = req.user;
    const { courseId } = req.params;
    const result = yield purchase_service_1.PurchaseService.cancelEnrollment(user.id, courseId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
